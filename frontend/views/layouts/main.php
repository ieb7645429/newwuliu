    ...
    <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-2">
            ...
            <?php  if(isset($this->context->layout_data)&&isset($this->context->layout_driver_id)){//司机领队-同城司机列表?>
                <div class="list-group">
                <?php foreach($this->context->layout_data as $key=>$value){?>
                <button class="driver-list <?php if($this->context->layout_driver_id==$key){?> driver-active <?php }?>" data-driver-id = <?php echo $key;?> ><?= $value?></button>
                <?php }?>
                </div>
            <?php }?>
          </div>
