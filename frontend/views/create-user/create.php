...
use frontend\assets\CreateUserCreateAsset;
            ...
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                echo $form->field($model, 'district')->widget(\chenkby\region\Region::className(),[
                        ...
                        'city'=>[
                            ...
                            'options'=>['class'=>'form-control form-control-inline sign-up-droplist','prompt'=>'选择城市', 'value' => 107, 'disabled' => 'disabled']
                        ],
                        'district'=>[
                            'attribute'=>'member_areaid',
                            'items'=>$area::getRegion(107),
                            'options'=>['class'=>'form-control form-control-inline sign-up-droplist','prompt'=>'选择县/区', 'value' => 1531, 'disabled' => 'disabled']
                        ]
                ]);
                ?>
                <?= Html::input('hidden', 'CreateUserForm[member_provinceid]', 6, []) ?>
                <?= Html::input('hidden', 'CreateUserForm[member_cityid]', 107, []) ?>
                <?= Html::input('hidden', 'CreateUserForm[member_areaid]', 1531, []) ?>
                <?= $form->field($model, 'member_areainfo')->textarea(['rows'=>3, 'value'=>'西部汽配城'])?>
