...
use frontend\modules\dl\models\Log;
...
class LogisticsOrder extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['order_state', 'state', 'abnormal', 'collection', 'order_type', 'member_id', 'member_cityid','receiving_provinceid', 'receiving_cityid', 'receiving_areaid', 'terminus_id', 'logistics_route_id', 'shipping_type'], 'integer'],
...
// $condition['logistics_order.order_id'] = $this::getOrderId($goods_sn);
    ...
    public function isDriverManager($role,$order_id){
        $goods = new Goods();
        if($role==Yii::$app->params['roleDriverManagerCityWide']||$role==Yii::$app->params['roleDriverManager']||'大连司机同城领队'||'大连司机领队'){
