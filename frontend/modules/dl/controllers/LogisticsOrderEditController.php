...
use frontend\modules\dl\models\LogisticsOrderEditSearch;
...
//        echo 'w4eq'; die();
    ...
    private function _getActiveMenu() {
        $arr = array(
            'index' => ['menu' => '/dl/logistics-order-edit/index', 'item' => 'dl/logistics-order-edit/index'],
            'view' =>  ['menu' => '/dl/logistics-order-edit/index', 'item' => false],
...
//            'pay' => ['menu' => '/employee/pay', 'item' => false],
        ...
        if($role==Yii::$app->params['roleEmployeeDelete']){
            ...
            $arr['update'] = ['menu' => '/dl/logistics-order-edit/index', 'item' => false];
        }
