...
use frontend\modules\dl\assets\DriverManagerCityWideAsset;
...
<?php $form = ActiveForm::begin(['method'=>'get'])?>
   ...
   <?= $form->field($route, 'logistics_route_id')->label('选择路线')->dropDownList($routeList,['prompt' => '请选择路线','options'=>[$route_id=>['Selected'=>true]]]) ?>
    <?= $form->field($LogisticsOrder, 'driver_member_id')->label('选择司机')->dropDownList($driverList,['prompt' => '请选司机','options'=>[$driver_member_id=>['Selected'=>true]]]) ?>
    <?php echo Html::submitButton('搜索', ['class'=>'btn btn-primary','name' =>'submit-button']) ?>
    <?php echo Html::button('打印送货单', ['class'=>'btn btn-primary js-print']) ?>
    <?php echo Html::button('打印码单', ['class'=>'btn btn-primary js-print-memo']) ?>
<?php ActiveForm::end()?>
