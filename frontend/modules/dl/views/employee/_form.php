...
<div class="table01">
        ...
        <?= $form->field($model, 'order_type')->dropDownList(array('1'=>'不老街'),['options'=>[$model->order_type=>['Selected'=>true]],'disabled'=>$disabled]) ?>
       <?php if($disabled){?>
...
<div class="table01">
    <div class="table_div">
    <?= $form->field($model, 'member_cityid')->dropDownList($area::getAreaId(108), []) ?>
    </div>
    <div class="table_div" style="display:none">
    <?= $form->field($model, 'goods_num')->hiddenInput(['maxlength' => true, 'value' => 1]) ?>
    </div>
</div>
...
<div class="table02">
    ...
    <?= Html::input('hidden', 'LogisticsOrder[receiving_cityid]', $model->receiving_cityid ? $model->receiving_cityid : 108, ['id'=>'logisticsorder-receiving_cityid']) ?>
...
<!--  <div class="table_div_02 no-charge">
    <?= $form->field($model, 'collection_poundage_two')->textInput(['maxlength' => true, 'value' => 0]) ?>
</div>
...
<div class="form-group field-info-goods_info" style="display: none">
    <div class="title_bg">
        <span>商品详细信息</span>
    </div>
    <div class="table01">
