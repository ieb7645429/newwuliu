...
/* @var $model common\models\LogisticsOrderDeleteSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="logistics-order-delete-search">
    ...
    <?php // echo $form->field($model, 'aaa') ?>

    <?php // echo $form->field($model, 'delete_member_id') ?>
