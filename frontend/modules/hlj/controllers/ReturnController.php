...
use Yii;
use frontend\modules\hlj\models\LogisticsReturnOrder;
use frontend\modules\hlj\models\LogisticsOrder;
use frontend\modules\hlj\models\LogisticsReturnOrderSearch;
use frontend\modules\hlj\models\ReturnOrderTime;
use frontend\modules\hlj\models\ReturnInfo;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use frontend\modules\hlj\models\ReturnGoods;
...
//     	}
    ...
    private function _getActiveMenu() {
        $arr = array(
            'index' => ['menu' => '/hlj/return/index', 'item' => '/hlj/return/index'],
            'index-over' => ['menu' => '/hlj/return/index', 'item' => '/hlj/return/index-over'],
            'create' => ['menu' => '/hlj/return/index', 'item' => false],
            'create2' => ['menu' => '/hlj/return/index', 'item' => false],
            'view' => ['menu' => '/hlj/return/index', 'item' => false],
            'update' => ['menu' => '/hlj/return/index', 'item' => false],
            'update2' => ['menu' => '/hlj/return/index', 'item' => false],
            'view2' => ['menu' => '/hlj/return/index', 'item' => false],     );
