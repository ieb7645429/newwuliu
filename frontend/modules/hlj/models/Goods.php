...
class Goods extends \yii\db\ActiveRecord
{
    ...
    public function logisticsRoute($orderId, $userId){
    	...
    	$model = new LogisticsCar();
    	$orderData = $modelOrder->findOne($orderId);
    	$logisticsRouteInfo = $model::find()->innerJoin('driver','driver.logistics_car_id = logistics_car.logistics_car_id')
    	->where(['logistics_car.logistics_route_id'=>$orderData->logistics_route_id, 'driver.member_id'=>$userId])
    	->asArray()
    	->all();
