...
class LogisticsOrderDelete extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['goods_num', 'order_state', 'state', 'freight_state', 'goods_price_state', 'abnormal', 'collection', 'order_type', 'add_time', 'member_id', 'member_cityid', 'receiving_provinceid', 'receiving_cityid', 'receiving_areaid', 'terminus_id', 'logistics_route_id', 'shipping_type', 'employee_id', 'driver_member_id', 'test',  'same_city', 'delete_member_id'], 'integer'],
            [['add_time'], 'required'],
