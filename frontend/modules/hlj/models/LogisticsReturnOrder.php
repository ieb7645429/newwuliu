...
//     	$modelAuthAssignment  = new AuthAssignment();
    ...
    public function getReturnLogisticsSn($order_id, $str = 'T')
    {
        ...
        return $str.$module->params['city_num'].str_pad($order_id,8,"0",STR_PAD_LEFT);
    }
    ...
    public function tagOrderPrint($order_id){
        ...
        $data[0]['routeInfo']['logistics_route_name'] = '';
// 		$data[0]['district'] = $area::findOne($data[0]['receiving_areaid'])->area_name;
    ...
    public function returnList($logistics_sn,$goods_sn,$where){
        ...
        $orderList = $this::find()->joinWith('memberCity')->joinWith('returnGoods')->joinWith('shippingType')->where(['and',$where,$condition])->asArray()->all();
     ...
     * 靳健
     */
    public function getReturnWhere($order_state,$add_time=null,$other=null){
