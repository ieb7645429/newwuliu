...
class LogisticsReturnOrderSearch extends LogisticsReturnOrder
{
    public function attributes(){
        return array_merge(parent::attributes(),['advance']);
    }
    ...
    {
        return [
            [['order_id', 'goods_num', 'order_state', 'state', 'abnormal', 'collection', 'order_type', 'return_type', 'member_id', 'member_cityid', 'receiving_provinceid', 'receiving_cityid', 'receiving_areaid', 'terminus_id', 'shipping_type'], 'integer'],
            [['logistics_sn', 'ship_logistics_sn', 'goods_sn', 'order_sn', 'member_name', 'member_phone', 'receiving_name', 'receiving_phone', 'add_time', 'receiving_name_area','advance'], 'safe'],
