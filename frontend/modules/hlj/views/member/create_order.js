var createOrder = {
    ...
    _setEvent : function() {
		...
		$('#logisticsorder-member_phone').on('blur', this._phoneGetMemberInfo);
		$('#user-username').on('blur', this._nameGetMemberInfo);
    },
    ...
    _addGoosInfoClickCallBack : function() {
        $(createOrder._getGoodsInfoHtml()).insertBefore($(this));
    },
    _phoneGetMemberInfo : function(){
