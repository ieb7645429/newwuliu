...
//            'terminus_id',
            [
                ...
                'label' => '落地点',
                'value'=>function($model) {
                        return frontend\modules\hlj\models\Terminus::getNameById($model->terminus_id);
                },
            ],
//            'logistics_route_id',
        [
            ...
            'label' => '物流线路',
            'value'=>function($model){
                    return frontend\modules\hlj\models\LogisticsRoute::getLogisticsRouteNameById($model->logistics_route_id);
            },
...
//            'employee_id',
            [
                ...
                'label' => '开单员',
                'value' => function($model) {
                        return frontend\modules\hlj\models\User::getUserNameById($model->employee_id);
                },
            ],
//            'driver_member_id',
            [
                ...
                'label' => '司机',
                'value' => function($model) {
                    return frontend\modules\hlj\models\User::getUserNameById($model->driver_member_id);
                },
            ],
//            'test',
            [
...
//            'edit_member_id',
            [
                ...
                'label' => '修改操作员',
                'value' => function($model) {
                    return frontend\modules\hlj\models\User::getUserNameById($model->edit_member_id);
                },
            ],
        ],
    ]) ?>
