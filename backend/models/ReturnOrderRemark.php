...
/**
 * This is the model class for table "return_order_remark".
 *
 ...
 */
class ReturnOrderRemark extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     * @param unknown $params
     */
    public function addSender($params){
        $model = $this::findOne($params['order_id']);
        if(empty($model)){
