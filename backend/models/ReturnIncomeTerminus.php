...
class ReturnIncomeTerminus extends LogisticsReturnOrderSearch
{
    /**
     * 取得订单列表
    ...
    public function getLogisticsOrderList($params) {
        ...
        $query->select('logistics_return_order.*, return_order_time.price_time, return_order_time.unload_time, return_order_remark.content, return_order_remark.terminus_content');
