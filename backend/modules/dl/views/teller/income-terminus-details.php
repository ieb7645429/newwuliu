...
use backend\modules\dl\assets\TellerIncomeTerminusDetailsAsset;
use backend\modules\dl\assets\TellerReturnIncomeTerminusDetailsAsset;

TellerIncomeTerminusDetailsAsset::register($this);
TellerReturnIncomeTerminusDetailsAsset::register($this);
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td class="remark" data-id="<?= $order['order_id']?>"><?= $order['content'] ?></td>
