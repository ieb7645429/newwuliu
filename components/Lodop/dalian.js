...
$(function(){
   ...
   function printfinancial(data) {
	...
	function Counterfoil_Style(data,type){
	 ...
	 text+= '<tr>';
	 text+= '<td width="380" height="5" colspan="1">货号：'+data[i]['goods_sn']+'</td>';
	 text+= '<td width="190" height="5" align="left" colspan="1">'+formatDateTime(data[i]['add_time'])+'</td>';
	 text+= '<td width="190" height="5" colspan="1" align="center" height="5">票号：'+data[i]['logistics_sn']+'</td>';
	 text+= '</tr>';
	 }
	 text+= '<tr>';
	 text+= '<td colspan="4">';
...
//    text+='</table>';
	...
	text+= '<tr  bgcolor="#000000">';
	text+= '<td colspan="5" rowspan="2" align="center" bgcolor="#FFFFFF">&nbsp;</td>';
	text+= '<td height="50" align="center" bgcolor="#FFFFFF">备注</td>';
	text+= '<td height="50" colspan="2" align="center" bgcolor="#FFFFFF">&nbsp;</td>';
	text+= '</tr>';
	text+= '<tr  bgcolor="#000000">';
	text+= '<td height="5" align="center" bgcolor="#FFFFFF">操作员</td>';
	text+= '<td height="5" colspan="2" bgcolor="#FFFFFF">&nbsp;</td>';
	text+= '</tr>';
	text+= '</table>';
	text+= '</td>';
	text+= '</tr>';
 ...
 var collection = '';
	...
	if(data[i]['order_sn'] != null){
	  if(data[i]['order_sn'].indexOf('"')>0){
		 ...
		 text+= '订单编号&nbsp;&nbsp'+data[i]['order_sn'];
	  }
	}
    text+= '</div></td>';
