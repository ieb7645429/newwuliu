...
/**
 * This is the model class for table "logistics_order_fushun".
 *
 ...
 * @property int $aaa
 */
class LogisticsOrderFushun extends LogisticsOrder
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['goods_num', 'order_state', 'state', 'freight_state', 'goods_price_state', 'abnormal', 'collection', 'order_type', 'add_time', 'member_id', 'member_cityid', 'receiving_provinceid', 'receiving_cityid', 'receiving_areaid', 'terminus_id', 'logistics_route_id', 'shipping_type', 'employee_id', 'driver_member_id', 'test', 'scale', 'same_city', 'aaa'], 'integer'],
            [['add_time'], 'required'],
